...
import com.province.libcacheline.body.BaseBodyBuilder;
...
import com.province.libcacheline.data.MapExtractor;
import com.province.libcacheline.data.SqliteDBHelper;
import com.province.libcacheline.data.UploadManager;
import com.province.libcacheline.data.UploadRelationManager;
import com.province.libcacheline.data.beans.Pager;
import com.province.libcacheline.data.beans.RelationObject;
import com.province.libcacheline.data.beans.SettingUnit;
import com.province.libcacheline.data.beans.UploadObject;
import com.province.libcacheline.utils.JSONUtil;
        ...
        synchronized (CacheKernel.class) {
            try{
                ...
                if(settingUnit.CacheType() == CacheType.CacheDownLoad){ //下行数据.
                    ...
                    ExtractorBase dataExtractor = new MapExtractor(value);
